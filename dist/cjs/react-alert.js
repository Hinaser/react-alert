...
var Provider = function Provider(_ref) {
  ...
  React.useEffect(function () {
    var doc = nodeRef.current ? nodeRef.current.ownerDocument : document;
  ...
  return React__default.createElement(Context.Provider, {
    value: alertContext,
    ref: nodeRef
  }, children, root.current && reactDom.createPortal(React__default.createElement(React.Fragment, null, Object.values(positions).map(function (position) {
