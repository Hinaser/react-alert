import React, { createContext, useMemo, useRef, useState, useEffect, Fragment, useContext } from 'react';
...
var Provider = function Provider(_ref) {
  var children = _ref.children,
    ...
    props = _objectWithoutProperties(_ref, ["children", "offset", "position", "timeout", "type", "transition", "containerStyle", "template", "context", "rootRef"]);
  ...
  useEffect(function () {
    var doc = _ref.rootRef && _ref.rootRef.current ? _ref.rootRef.current.ownerDocument : document;
